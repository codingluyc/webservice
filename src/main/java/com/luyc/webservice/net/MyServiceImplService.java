 ...
 * 
 */
@WebServiceClient(name = "MyServiceImplService", targetNamespace = "http://service.webservice.luyc.com/", wsdlLocation = "http://localhost:8080/webservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICEIMPLSERVICE_QNAME = new QName("http://service.webservice.luyc.com/", "MyServiceImplService");
    ...
    public MyServiceImpl getMyServiceImplPort() {
        return super.getPort(new QName("http://service.webservice.luyc.com/", "MyServiceImplPort"), MyServiceImpl.class);
    }
    ...
    public MyServiceImpl getMyServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.webservice.luyc.com/", "MyServiceImplPort"), MyServiceImpl.class, features);
    }
